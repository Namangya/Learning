...
# Question 2: Monotonic Array - An array is monotonic if it is either 
# monotone increasing or monotone decreasing. An array is monotone 
# increasing if all its elements from left to right are non-decreasing. 
# An array is monotone decreasing if all  its elements from left to 
# right are non-increasing. Given an integer array return true if the 
